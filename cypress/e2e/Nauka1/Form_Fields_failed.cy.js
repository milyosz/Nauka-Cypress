...
describe('Form Fields', () => {
    ...
    let savedUrl;
    it('Form Testing', () => {
      cy.visit('https://practice-automation.com/form-fields/') ///w cypress nie musimy pisać waitów
      ...
      cy.get('#g1103-whatisyourfavoritecolor-Green')
        ...
        cy.get('#g1103-doyouhaveanysiblings-button').should('contain', 'Select one option')
